  ...
  return (
    <header className="bg-white text-navText p-header flex items-center justify-between w-full max-w-header h-header opacity-100">
      <div className="flex flex-col items-center gap-0 opacity-100">
        ...
        <p className="font-fira text-custom italic font-medium leading-custom text-left  h-custom-p opacity-100 pt-2">
          Transforming the future
        </p>
      </div>
      <div className="flex items-center space-x-28">
        <nav className="flex space-x-14 text-navText text-base font-fira font-semibold">
          <a
            href="#home"
        ...
        <div className="flex items-center justify-center gap-10">
          <a
            href="#hire"
            className="bg-hireMe text-base text-white font-bold py-2 px-4 h-hire-btn w-hire-btn flex items-center justify-center"
          >
            Hire Us
          </a>
        </div>
