    ...
    <div className="p-8">
      ...
      <div className="flex flex-wrap justify-center font-fira font-normal">
        <div className="flex flex-col items-start w-full md:w-1/3 pr-10">
          ...
          <h3 className="text-base font-fira mb-2">Our Mission</h3>
        ...
        <div className="flex flex-col items-start w-full md:w-1/3 pr-10">
          ...
          <h3 className="text-base font-fira mb-2">Our Vision</h3>
          <p className="text-textCustom">
        ...
        <div className="flex flex-col items-start w-full md:w-1/3 pr-10">
          ...
          <h3 className="text-base font-fira mb-2">Our Core Values</h3>
          <p className="text-textCustom">
      ...
      <div className="flex justify-between mt-8">
        ...
        <div className="w-3/6 p-4">
          <div>
            <h1 className="text-2xl lg:text-3xl mb-4 font-fira font-medium">
              Know the Team Lead
            </h1>
